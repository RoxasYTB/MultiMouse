...
exports.MouseDetector = void 0;
const child_process_1 = require("child_process");
const electron_1 = require("electron");
const events_1 = require("events");
class MouseDetector extends events_1.EventEmitter {
    constructor() {
        super();
    ...
    scanForMouseDevices() {
        ...
        (0, child_process_1.exec)(`powershell -Command "${command}"`, { encoding: 'utf8' }, (error, stdout) => {
            if (error) {
...
exports.MouseDetector = MouseDetector;
//# sourceMappingURL=mouse_detector.js.map